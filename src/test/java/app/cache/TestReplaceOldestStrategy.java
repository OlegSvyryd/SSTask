...
/**
 * This class testing Cache collection with REPLACE_OLDEST strategy
 * @author ol
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class TestReplaceOldestStrategy {

    private final static int CAPACITY = 5;                                              //capacity
    private final static long LIFETIME = 5000l;                                         //lifetime in cache - 5 second
    private final static Strategy STRATEGY = Strategy.REPLACE_OLDEST;                   //displacement strategy
    ...
    public void test00PutItems() {
        System.out.println("--- Running test with cache REPLACE_OLDER displacement strategy ---");
    ...
    public void test05StrategyDisplacement() {
        ...
        String oldestEntry = cacheStorage.get(keys[0]);

        System.out.println(" > Entries: ");
        display(cacheStorage);

        System.out.println(" > Put 2 new items: ");
        ...
        for(Map.Entry entry : cacheStorage.entrySet()) {
            ...
            Assert.assertNotEquals(oldestEntry, entry.getValue());
        }
        ...
        System.out.println(" > Capacity of cache before adding 2 new items equals 4, " +
                ...
                "and in this strategy, oldest entry(" + oldestEntry + ") is removed from cache.");
    }
